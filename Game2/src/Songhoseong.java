...
public class Songhoseong extends Player{
	...
	public void underAttack(Player attacker) {
		...
		if (attacker.name.equals("송호성")) {
			Songhoseong tmp = (Songhoseong)attacker;
			System.out.println(attacker.name);
			damage = tmp.damage;
			
		}
		
		this.balance(attacker);		
...
//		System.out.println(tmp_heal+" "+per20);
	...
	public void balance(Player attacker) {
