...
;
		...
		if (this.callGoogleGod()) { // 구글신을 소환하였을때 출력됨
			...
			System.out.println("Write in Go! Write in Go!");
			System.out.println("Go로 짜! Go로 짜! ♪");
			System.out.println("No inheritance anymore");
			System.out.println("클래스 상속이여 이제 그만 안녕~ ♪");
			System.out.println("Write in Go! Write in Go!");
			System.out.println("Go로 짜! Go로 짜! ♪");
			System.out.println("There's no do or while, just for");
			System.out.println("do도 while도 없어, 오직 for뿐~ ♪");
			System.out.println("I don't care what your linters say");
			System.out.println("당신의 린터가 뭐라고 말하든 상관없어~ ♪");
			System.out.println("I've got tools for that");
			System.out.println("내겐 수정툴이 있다고~ ♪");
			System.out.println("The code never bothered me anyway");
			System.out.println("코드는 더 이상 날 괴롭힐 수 없어~ ♪");
